  ...
  <ResponsiveContainer width="100%" height={300}>
    <AreaChart data={data}>
      ...
      <Legend
        formatter={() => (
          <span>
            <i className="fa fa-thermometer-half" aria-hidden="true" style={{ color: "#ff7300", marginRight: "5px" }} />
            Temperature
          </span>
        )}
      />
  ...
  <ResponsiveContainer width="100%" height={300}>
    <AreaChart data={data}>
      ...
      <Legend
        formatter={() => (
          <span>
            <i className="fa fa-tint" aria-hidden="true" style={{ color: "#00bfff", marginRight: "5px" }} />
            Humidity
          </span>
        )}
      />
    ...
    <>
      <nav className="navbar">
        <div className="navbar-left">
          ...
          <img src="https://res.cloudinary.com/dxoq1rrh4/image/upload/v1721754287/left_xfp4qb.png" alt="Left Logo" className="logo" />
        </div>
        <div className="navbar-title">
          <h1>5G Use Cases</h1>
        </div>
        <div className="navbar-right">
          <img src="https://res.cloudinary.com/dxoq1rrh4/image/upload/v1721739306/smartcity_jgrecd.png" alt="Right Logo" className="logos" />
        </div>
      </nav>
      ...
      <div className={`sidebar ${sidebarOpen ? "open" : "close"}`}>
        <ul className="but">
          <li>
            <Link to="/smartcity5gusecases">
              <i className="fa fa-home"></i> HomePage
            </Link>
          </li>
          <li>
            <Link to="/smartcity5gusecases/indoorair">
